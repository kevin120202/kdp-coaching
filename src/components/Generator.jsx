...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            <Header index={'01'} title={'Pick your split'} description={"Select the workout you wish to complete."} />
            ...
            <Header index={'02'} title={'Choose the muscle group'} description={"Select the muscles for annihilation."} />
            ...
            <Header index={'03'} title={'Become better than yesterday'} description={"Select your goal."} />
